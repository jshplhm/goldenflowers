...
<section class="pf-group" id="lush-romantic">
  ...
  <div class="pf-grid">
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/katie-james">
      <img src="{{ site.baseurl }}/assets/images/pages/katie-james-01-msch3pw2-mschbtqy.jpg" alt="Katie &amp; James wedding flowers: The Miner's Foundry, Nevada City" loading="eager" fetchpriority="high">
...
<section class="pf-group" id="wildflower-modern">
  ...
  <div class="pf-grid">
    ...
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/tori-tucker">
      <img src="{{ site.baseurl }}/assets/images/portfolio/tori-tucker/tori-tucker-17.jpg" alt="Tori &amp; Tucker wedding flowers: North Tahoe Event Center, Kings Beach" loading="lazy">
