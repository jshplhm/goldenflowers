...
<section class="pf-group" id="elevated-minimalist">
  ...
  <div class="pf-grid">
    ...
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/sarah-brian">
      <img src="{{ site.baseurl }}/assets/images/portfolio/sarah-brian/sarah-brian-06.jpg" alt="Sarah &amp; Brian wedding flowers: hanging greenery and white floral ceremony installation, The Miner's Foundry, Nevada City" loading="lazy" style="object-position:center 40%;">
