...
<section class="pf-group" id="lush-romantic">
  ...
  <div class="pf-grid">
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/katie-james">
      <img src="{{ site.baseurl }}/assets/images/pages/katie-james-01-msch3pw2.jpg" alt="Katie &amp; James wedding flowers: The Miner's Foundry, Nevada City" loading="eager" fetchpriority="high">
