...
<section class="pf-group" id="wildflower-modern">
  ...
  <div class="pf-grid">
    ...
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/tori-tucker">
      <img src="{{ site.baseurl }}/assets/images/pages/tori-tucker-17-mshqrq0b.jpg" alt="Tori &amp; Tucker wedding flowers: North Tahoe Event Center, Kings Beach" loading="lazy">
