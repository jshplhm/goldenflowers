...
<section class="pf-group" id="lush-romantic">
  ...
  <div class="pf-grid">
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/katie-james">
      <img src="{{ site.baseurl }}/assets/images/portfolio/katie-james/katie-james-10.jpg" alt="Katie &amp; James wedding flowers: The Miner's Foundry, Nevada City" loading="eager" fetchpriority="high">
