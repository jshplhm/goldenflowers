...
<section class="pf-group" id="wildflower-modern">
  ...
  <div class="pf-grid">
    <a class="pf-card" href="{{ site.baseurl }}/portfolio/camille-max">
      <img src="{{ site.baseurl }}/assets/images/portfolio/camille-max/camille-max-01.jpg" alt="Camille &amp; Max wedding flowers: North Star House, Grass Valley" loading="lazy">
