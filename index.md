...
<section class="pband">
  <div class="pb-row pb-row--split rev pb-sq">
    ...
    <figure class="pb-pic"><img src="{{ site.baseurl }}/assets/images/portfolio/kelly-dylan/kelly-dylan-31.jpg"{% include img-dims.html path="/assets/images/portfolio/kelly-dylan/kelly-dylan-31.jpg" %} loading="lazy" alt="A beach ceremony set on the shore of Lake Tahoe, an arch and chairs waiting under a grey sky"></figure>
  </div>
</section>
