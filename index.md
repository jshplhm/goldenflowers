...
<section class="pband">
  <div class="pb-row pb-row--split rev pb-sq">
    ...
    <figure class="pb-pic"><img src="{{ site.baseurl }}/assets/images/portfolio/tori-tucker/tori-tucker-05.jpg"{% include img-dims.html path="/assets/images/portfolio/tori-tucker/tori-tucker-05.jpg" %} loading="lazy" alt="A beach ceremony set on the shore of Lake Tahoe, an arch and chairs waiting under a grey sky"></figure>
  </div>
</section>
