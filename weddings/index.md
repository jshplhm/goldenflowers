...
<section class="form-section" id="consultation">
  <div class="container" style="max-width:1100px;">
    ...
    <h2>Let's start the<br>conversation.</h2>
...
<div class="faq-section">
  <div class="container" style="max-width:1100px;">
    ...
    <h2>What makes Golden Flowers<br>different from other florists?</h2>
    <div class="faq-list">
      <div class="faq-item open">
        <div class="faq-question" onclick="toggleFaq(this)">
          <h3>What actually makes you different?</h3>
          <div class="faq-toggle" style="background:var(--acc);border-color:var(--acc);color:var(--bg);">×</div>
        </div>
...
<div class="venue-ctas">
  <div class="container" style="max-width:1100px;">
    ...
    <h2 style="font-size:2rem;">Planning at a specific venue?<br>We've been there.</h2>
