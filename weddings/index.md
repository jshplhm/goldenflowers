    ...
    <form action="https://formspree.io/f/xgobrjyo" method="POST" id="consultation-form" data-multistep data-ajax>
      ...
      <div class="form-step-2">
        ...
        <div class="field-full">
          ...
          <textarea id="message" name="message" placeholder="Your venue, your vision, anything that matters to you. The more context you give us, the better conversation we can have." rows="4"></textarea>
        </div>
