...
<section class="form-section" id="consultation">
  <div class="container" style="max-width:1100px;" data-form-wrap>
    ...
    <div id="consultation-success" class="form-success" data-form-success hidden>
      ...
      <p data-success-date-line hidden>We've got your details for <strong data-success-date></strong>. We'll be in touch within <strong>48 hours</strong> to confirm availability, by phone or video.</p>
      <p data-success-default>We'll be in touch within <strong>48 hours</strong> to confirm availability, by phone or video.</p>
      <div class="form-success-book">
        <p class="form-success-book-prompt">Prefer to skip the wait? Grab 30 minutes with Brittany.</p>
        <a href="https://calendar.app.google/iKY1Xqerqtcv6fdj7" target="_blank" rel="noopener" class="btn-primary">Book a consultation call &rarr;</a>
      </div>
