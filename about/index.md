  ...
  <div class="container">
    ...
    <div class="values-grid">
      ...
      <div class="value-item">
        ...
        <p>Every wedding gets a design built from scratch around its specific venue, season, and vision. There are no packages. Brittany designs each proposal as if it's the only one she's ever working on.</p>
      </div>
      <div class="value-item">
        <h3>Sustainable at the root</h3>
        <p>Foam-free construction, California-grown sourcing, and farm management practices that treat soil health as a long-term investment. The environmental ethic runs through the whole operation.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section pledge">
  <div class="container">
    ...
    <div class="pledge-grid">
      ...
      <article class="pledge-card">
        <span class="pledge-icon" aria-hidden="true">
          {% include icon.html name="refresh" %}
        </span>
      ...
      <article class="pledge-card">
        <span class="pledge-icon" aria-hidden="true">
          {% include icon.html name="recycle" %}
        </span>
